...
{
    $sub_id=$_POST['sub_id'];
    $cou_period=DateThaiShortNotime($_POST['cou_period1'])."-".DateThaiShortNotime($_POST['cou_period2']);
...
values('".$sub_id."','".$cou_period."','".$cou_round."','".$cou_price."','".$cou_level."','".$cou_limit."',0,'เปิดรับ')";
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data"><!-- ต้องใส่ทุกครั้ง <input type="file">-->
                <table class="table">
                        ...
                        <td> 
                            <select class="form-select" name="sub_id" id="sub_id"  require="true">
                                <?php
                                        ...
                                        {
                                            echo '<option value="'.$rs1['sub_id'].'" >'.$rs1['sub_name'].'</option>';
                    ...
                    <tr>
                        <td>ช่วงเวลา</td>
                        <td> <input type="date" name="cou_period1" id="cou_period1" class="form-control" require="true"> 
                        ถึง <input type="date" name="cou_period2" id="cou_period2" class="form-control" require="true"> </td>
                    </tr>
                    <tr>
                        <td>รอบเรียน</td>
                        <td> <input type="text" name="cou_round" id="cou_round" class="form-control" require="true"> </td>
                    </tr>
                    <tr>
                        <td>ราคา</td>
                        <td> <input type="number" name="cou_price" id="cou_price" min="0" max="10000" class="form-control" require="true"> </td>
                    </tr>
                    <tr>
                        <td>ระดับชั้น</td>
                        <td> <input type="text" name="cou_level" id="cou_level" class="form-control" require="true"> </td>
                    </tr>
                    <tr>
                        <td>จำนวนเปิดรับ</td>
                        <td> <input type="number" name="cou_limit" id="cou_limit" class="form-control" require="true"> </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td> 
